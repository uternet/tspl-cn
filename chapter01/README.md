...
Scheme 的核心语法很小，扩展语法是在核心语法的基础上派生而来，核心语法加上扩展语法再加上一组元过程（比如+ - * /)构成了完整的 Scheme 语言。一个 Scheme 解释器或编译器可以相当小巧，具备潜在的快速及高可靠性。很多扩展语法及元过程可以由 Scheme 自身定义出来。简化了实现的难度，而且增加了可靠性。
...
Scheme 的变量及关键字采用词法作用域，Scheme 程序使用块结构。
